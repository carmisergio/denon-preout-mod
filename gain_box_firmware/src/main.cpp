...
constexpr Pin OUT_TRIG_PIN = Pin::P_PA6;
constexpr Pin OUT_UNMUTE_PIN = Pin::P_PA7;
#else
#error Unsupported MCU!
#endif

// Delay configuration
constexpr uint32_t D_AC_DETECT_TIME = 40;
...
int main()
{
  ...
  while (true)
  {
    ...
    bool ac_en = d_ac_en_off.process(ac_detect, time);    // AC_EN output signal
